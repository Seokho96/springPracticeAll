...
<%@page import="bit.com.a.dto.PolSubDto"%>
...
<%
List<PolSubDto> list = (List<PolSubDto>)request.getAttribute("pollsublist");

// json 생성.		JSONobject, JSONarray
String jsonData = "[";

for(PolSubDto p : list){
	jsonData += "{ name:'" + p.getAnswer() + "', y:" + p.getAccount() + "}, ";
}
