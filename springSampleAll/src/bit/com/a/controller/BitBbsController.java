...
public class BitBbsController {
	...
	public List<BbsDto> bbslistData(BbsParam param) throws Exception{
		...
		bbsList = bbsservice.BbsList(param);
	...
	public int bbslistCount(BbsParam param) throws Exception {
		int count = 0;
		count =	bbsservice.getBbsCount(param);
		return count;
	}
}